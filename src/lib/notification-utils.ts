...
export const NOTIFICATION_TEMPLATES: Record<string, NotificationTemplate> = {
  ...
  SPRINT_ENDING_SOON: {
    ...
    message: (data) => `${data.sprintName} ends ${data.endsIn}. ${data.remainingTasks} tasks remaining`,
    priority: NotificationPriority.HIGH,
    category: NotificationCategory.SPRINT,
    requiresEmail: true,
    actionUrl: (data) => `/sprints/${data.sprintId}/board`,
  ...
  SPRINT_COMPLETED: {
    ...
    message: (data) => `${data.sprintName} completed with ${data.completedTasks}/${data.totalTasks} tasks done`,
    priority: NotificationPriority.MEDIUM,
    category: NotificationCategory.SPRINT,
    requiresEmail: true,
  ...
  LEAVE_REQUESTED: {
    ...
    message: (data) => `${data.employeeName} requested ${data.leaveType} leave for ${data.days} day(s)`,
    priority: NotificationPriority.HIGH,
  ...
  LEAVE_APPROVED: {
    ...
    message: (data) => `Your ${data.leaveType} leave request for ${data.days} day(s) has been approved by ${data.approverName}`,
    priority: NotificationPriority.HIGH,
    category: NotificationCategory.LEAVE,
    requiresEmail: true,
    actionUrl: () => `/leave`,
  ...
  LEAVE_REJECTED: {
    ...
    message: (data) => `Your ${data.leaveType} leave request has been rejected. Reason: ${data.reason}`,
    priority: NotificationPriority.HIGH,
    category: NotificationCategory.LEAVE,
    requiresEmail: true,
    actionUrl: () => `/leave`,
  ...
  ATTENDANCE_LATE: {
    ...
    message: (data) => `You checked in late today at ${data.checkInTime}. You are ${data.lateMinutes} minutes late`,
    priority: NotificationPriority.MEDIUM,
  ...
  COMMENT_MENTION: {
    ...
    requiresEmail: true,
    actionUrl: (data) => `/projects/${data.projectId}?task=${data.taskId}&comment=${data.commentId}`,
  },
