        ...
        <AlertDialog open={open} onOpenChange={onOpenChange}>
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        This action cannot be undone. This will permanently delete the workspace and all associated data including projects, tasks, epics, sprints, requirements, and team data.
                    </AlertDialogDescription>
                </AlertDialogHeader>
                ...
                <div className="space-y-4 py-4">
                    <Alert variant="destructive">
                        <AlertDescription>
                            You are about to delete: <strong className="font-semibold">{currentWorkspace.name}</strong>
                        </AlertDescription>
                    </Alert>
